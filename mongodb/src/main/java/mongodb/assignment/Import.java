package mongodb.assignment;
	...
	public class Import  implements Block<Document> {
		...
		public static void main(String[] args) throws FileNotFoundException {
			...
			File fileOpen = new File("C:\\Users\\kohli\\Downloads\\datasets\\mongodb","access.csv");
		...
		access.insertMany(documents);
			...
			Block<Document> printBlock = new Import();
